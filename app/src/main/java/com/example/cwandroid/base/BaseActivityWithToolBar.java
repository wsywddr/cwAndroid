...
import com.example.cwandroid.R;
...
public abstract class BaseActivityWithToolBar extends BaseActivity implements View.OnClickListener {
    ...
    protected void setBtnLeft1Enable(boolean isEnable) {
        if (isEnable) {
            MyUtils.show(btnLeft1);
            MyUtils.show(tv_back);
        } else {
            MyUtils.hide(btnLeft1);
            MyUtils.hide(tv_back);
        }
    }
    ...
    protected void setBtnLeft2Enable(boolean isEnable) {
        if (isEnable) {
            MyUtils.show(btnLeft2);
        } else {
            MyUtils.hide(btnLeft2);
        }
    }
    ...
    protected void setBtnRight1Enable(boolean isEnable) {
        if (isEnable) {
            MyUtils.show(btnRight1);
        } else {
            MyUtils.hide(btnRight2);
        }
    }
    ...
    protected void setTextRight1Enable(boolean isEnable) {
        if (isEnable) {
            MyUtils.show(textRight1);
        } else {
            MyUtils.hide(textRight1);
        }
    }

    protected void setTextRightEnable(boolean isEnable) {
        if (isEnable) {
            MyUtils.show(tv_right);
        } else {
            MyUtils.hide(tv_right);
        }
    }
    ...
    protected void setTextLeft1Enable(boolean isEnable) {
        if (isEnable) {
            MyUtils.show(lefttv1);
        } else {
            MyUtils.hide(lefttv1);
        }
    }
    ...
    protected void setTextRight2Enable(boolean isEnable) {
        if (isEnable) {
            MyUtils.show(textRight2);
        } else {
            MyUtils.hide(textRight2);
        }
    }
