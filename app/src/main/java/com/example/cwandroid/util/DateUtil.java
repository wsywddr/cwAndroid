...
public class DateUtil {
    ...
    public enum DateStyle {
        ...
        YYYY_M_D_HH_MM_SS("yyyy-M-d HH:mm:ss", false),
        ...
        YYYY_MM_CN("yyyy年MM�?", false),
        YYYY_MM_DD_CN("yyyy年MM月dd�?", false),
        YYYY_MM_DD_HH_MM_CN("yyyy年MM月dd�? HH:mm", false),
        YYYY_MM_DD_HH_MM_SS_CN("yyyy年MM月dd�? HH:mm:ss", false),
        ...
        MM_DD_CN("MM月dd�?", true),
        MM_DD_HH_MM_CN("MM月dd�? HH:mm", true),
        MM_DD_HH_MM_SS_CN("MM月dd�? HH:mm:ss", true);
